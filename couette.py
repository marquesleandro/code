...
name_mesh = 'malha_couette_4.msh'
mesh = trimsh.Linear('/home/marquesleandro/couette',name_mesh)
mesh.parameters(3)
mesh.ien()
mesh.coord()
...
for i in range(0, len(mesh.dirichlet_pts[1])):
 ...
 bc_dirichlet_vx[v1] = bc[line]
 bc_dirichlet_vx[v2] = bc[line]
...
for t in tqdm(range(0, nt)):
 ...
 save.saveVTK('/home/marquesleandro/couette/result_couette_4','couette%s' %t)
