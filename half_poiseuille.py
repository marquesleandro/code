...
name_mesh = 'malha_half_poiseuille.msh'
...
for i in range(0, len(mesh.dirichlet_pts[3])):
 ...
 if line == 11:  
  ...
  bc_dirichlet_psi[v1] = (v_max*mesh.y[v1]/3.0)*(3.0 - (mesh.y[v1]/L)**2)
  bc_dirichlet_psi[v2] = (v_max*mesh.y[v2]/3.0)*(3.0 - (mesh.y[v2]/L)**2)
...
for t in tqdm(range(0, nt)):
 ...
 save.saveVTK('./result_half_poiseuille','parallel%s' %t)
