...
name_simulator = 'lid_driven cavity'
...
end_time = time()
trimesh_time = end_time - start_time
print 'time duration: %.1f seconds' %trimesh_time
print ""
print ""
...
print '-----------------------------'
print 'Simulator: %s' %name_simulator
print 'Number of equations: %s' %number_equations
print ""
...
end_time = time()
trielem_time = end_time - start_time
print 'time duration: %.1f seconds' %trielem_time
print ""
print ""
...
end_time = time()
tricond_time = end_time - start_time
print 'time duration: %.1f seconds' %tricond_time
print ""
print ""
...
for t in tqdm(range(0, nt)):
 save = InOut.Linear(mesh.x,mesh.y,mesh.IEN,mesh.npoints,mesh.nelem,w,w,psi,vx,vy)
 save.saveVTK('./result_cavity_Re10','cavity%s' %t)
